...
public class BleWrapper {
    ...
    public void getCharacteristicValue(BluetoothGattCharacteristic ch) {
        ...
        else if (uuid.equals(ConstDefine.Characteristic.HEART_RATE_MEASUREMENT) || // manufacturer name string
        		 uuid.equals(ConstDefine.Characteristic.MODEL_NUMBER_STRING) || // model number string)
        		 uuid.equals(ConstDefine.Characteristic.FIRMWARE_REVISION_STRING)) // firmware revision string
        {
        ...
        else if(uuid.equals(ConstDefine.Characteristic.APPEARANCE)) { // appearance
        ...
        else if(uuid.equals(ConstDefine.Characteristic.BODY_SENSOR_LOCATION)) { // body sensor location
